...
$H_0 : \beta_j = 0$ for all $3$ predictor terms being dropped from the full model.
...
From the F-test results in Table @ref(tab:ftest-table), we can see that the test result was not statistically significant. 
