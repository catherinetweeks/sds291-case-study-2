...
A numerical variable avg_wage_region was created to group the dataset by Region and Race and calculate the mean weekly wages among these groups. We created this variable to visualize regional differences in mean weekly wage among Black and Non-black male individuals. 
...
##### Average Weekly Wage by Region and Race
...
The plots show how average wages increase with experience across all regions and that Black respondents consistently earn lower wages than non-Black respondents.
...
$$E[log(wage)|Education,Experience,Race,Region]= \beta_0 + \beta_1Education $$
$$+ \beta_2Experience+ \beta_3Race +
\beta_4NorthEast +\beta_5South + \beta_6West $$$$+ \beta_7Race*NorthEast + \beta_8Race*South \beta_9Race*West$$
